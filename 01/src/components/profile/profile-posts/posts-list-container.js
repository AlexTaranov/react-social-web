...
const PostsListContainer = connect(profileStateToProps, profileDispatchToProps)(PostsList); // почему две скобочки? Потому что мы первый раз вызвали ее, она вернула нам другую функцию, и мы вызываем потом ту функцию, которую вернул предыдущий вызов
